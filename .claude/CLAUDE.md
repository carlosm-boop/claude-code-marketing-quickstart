...
| Path | Purpose |
|---|---|
| [`skills/`](./skills/) | The 10 pre-seeded research skills (`brand-kit`, `competitor-aggregate`, `competitor-research`, `expert-pov`, `funnel-strategy`, `icp-research`, `positioning`, `product-messaging`, `tov-guidelines`, `win-loss-analysis`) — the producers (system of action) |
